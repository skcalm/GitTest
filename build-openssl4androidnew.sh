...
ANDROID_NDK="/home/user/work/ndk/android-ndk-r13"
ARCHS=("android" "android-armeabi" "android64-aarch64" "android-x86" "android64" "android-mips" "android-mips64")
ABIS=("armeabi" "armeabi-v7a" "arm64-v8a" "x86" "x86_64" "mips" "mips64")


source ./_sharednew.sh
...
configure_android_api(){
  if [[ "$1" == "android64-aarch64" ]] || 
     [[ "$1" == "android64" ]] || 
     [[ "$1" == "android-mips64" ]]; then
    ANDROID_API=21;
  else
    ANDROID_API=9;
  fi;
